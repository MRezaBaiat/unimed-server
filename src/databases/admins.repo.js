...
exports.AdminsSchema = mongoose_1.SchemaFactory.createForClass(matap_api_1.Admin)
    .plugin(mongoosePaginate)
    .pre(['find', 'findOne', 'findOneAndUpdate'], function () {
    this.lean();
});
let AdminsRepo = class AdminsRepo {
    constructor(adminsDB) {
    ...
    crud() {
        return new query_builder_1.default(this.adminsDB, matap_api_1.Admin);
    }
};
AdminsRepo = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)('admins')),
    __metadata("design:paramtypes", [mongoose_2.Model])
], AdminsRepo);
exports.default = AdminsRepo;
