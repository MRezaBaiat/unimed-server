...
const admin_logs_repo_1 = __importDefault(require("../../databases/admin.logs.repo"));
let AdminLoggerService = class AdminLoggerService {
    constructor(adminLogsRepo) {
        this.adminLogsRepo = adminLogsRepo;
    }
    query(query) {
...
AdminLoggerService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [admin_logs_repo_1.default])
], AdminLoggerService);
