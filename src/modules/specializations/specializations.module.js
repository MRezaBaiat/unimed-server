...
const specializations_admin_controller_1 = require("./specializations.admin.controller");
...
SpecializationsModule = __decorate([
    (0, common_1.Module)({
        controllers: [specializations_admin_controller_1.SpecializationsAdminController],
