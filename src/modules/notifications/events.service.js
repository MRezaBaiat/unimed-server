    ...
    notifyNewPatient(doctorId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (settings.newPatient.notification) {
                ...
                this.pushService.sendNotification(doctorId, new notifications_1.NewPatientNotification());
            }
    ...
    notifyWorkTimeStarted(doctorId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (settings.workTimeStarted.notification) {
                ...
                this.pushService.sendNotification(doctorId, new notifications_1.ResponseTimeStartedNotification());
            }
    ...
    notifyWorkTimeClose(doctorId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (settings.workTimeClose.notification) {
                ...
                this.pushService.sendNotification(doctorId, new notifications_1.WorkTimeNearNotification());
            }
    ...
    notifyWorkTimeEnded(doctorId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (settings.workTimeEnded.notification) {
                ...
                this.pushService.sendNotification(doctorId, new notifications_1.ResponseTimeEndedNotification());
            }
